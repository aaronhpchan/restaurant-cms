    ...
    <div class="row">
        <div class="col-lg-6 img-container"><img class="img" src="<?php echo url_for('/images/chocolate-glazed-donut-with-dried-cranberries.jfif'); ?>" alt="Chocolate Glazed Donut" />
            <div class="spinning-circle yellow-circle d-flex flex-column justify-content-center align-items-center">
                <div class="text-center fw-bolder">MON-SUN</div>
                <div class="text-center fw-bolder">11AM-7PM</div>
            </div>
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0 ps-lg-5">
            <h1 class="page-title display-3">Come on in for Donuts + Coffee and a good time. </h1>
        </div>
    </div>
</div>
<div class="my-4 marquee-section">
    ...
    <div class="row d-flex align-items-center pb-5 mb-5">
        <div class="col-lg-6 d-flex justify-content-center pe-lg-5">
            <div class="donut border-dashed">
                <div class="donut-hole d-flex flex-column justify-content-center align-items-center border-dashed">
                    <h2 class="h3 text-center">Bring along your friends and try out different flavours. &#128523; </h2>
                </div>
            </div>
        </div>
        <div class="col-lg-6 mt-5 mt-lg-0"><img class="img" src="<?php echo url_for('/images/coffees-donuts.jfif'); ?>" alt="Coffess and Donuts" />
        </div>
    </div>
    ...
    <div class="row align-items-end">
        <div class="col-lg-6 img-container"><img class="img" src="<?php echo url_for('/images/home-made-bagels.jpg'); ?>" alt="Homemade Bagels" />
            <div class="spinning-circle green-circle d-flex flex-column justify-content-center align-items-center">
                <div class="text-center fw-bolder">#DONUTS</div>
                <div class="text-center fw-bolder">#BAGELS</div>
                <div class="text-center fw-bolder">#COFFEE</div>
            </div>
        </div>
        <div class="col-lg-6 ps-lg-5">
            <h2 class="display-6 pb-3 pt-5">Did we mention we also make tasty bagels?</h2>
            <p class="fs-5">We have recently ventured into the world of bagels. We prides ourselves in our innovative menu as we here at Humphrey's Donuts are always looking to customize, improve and add new flavors to our menu. </p>
            <p class="fs-5">We also highly value our customers' wants so if there's anything you want to try, just let us know. We are always happy to give it a try!</p>
        </div>
    </div>
</div>
<div class="my-4 marquee-section-reverse">
    <div class="marquee-div">
        <div class="h3 my-4 marquee">&bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull; DONUTS &bull; BAGELS &bull; COFFEE &bull;</div>
    </div>
</div>
